...
// /// dingzhu patch: overload of BuildMI, which add parameter DebugLocSet
// inline MachineInstrBuilder BuildMI(MachineFunction &MF, const DebugLoc &DL,
//                                    const DebugLocSet &DLL, const InstIndex &II,
//                                    const InstIndexSet &IIS,
//                                    const MCInstrDesc &MCID ) {
//   return MachineInstrBuilder(MF, MF.CreateMachineInstr(MCID, DL, DLL, II, IIS));
// }
...
//                                    Register DestReg) {
//   MachineFunction &MF = *BB.getParent();
//   MachineInstr *MI = MF.CreateMachineInstr(MCID, DL, DLL, II, IIS);
//   BB.insert(I, MI);
//   return MachineInstrBuilder(MF, MI).addReg(DestReg, RegState::Define);
// }
...
//   // definition is not available in headers, so inline the check.
//   if (I.isInsideBundle())
//     return BuildMI(BB, MachineBasicBlock::instr_iterator(I), DL, DLL, II, IIS, MCID, DestReg);
//   return BuildMI(BB, MachineBasicBlock::iterator(I), DL, DLL, II, IIS, MCID, DestReg);
// }
...
//                                    const MCInstrDesc &MCID,
//                                    Register DestReg) {
//   return BuildMI(BB, *I, DL, DLL, II, IIS, MCID, DestReg);
// }
...
//   // definition is not available in headers, so inline the check.
//   if (I.isInsideBundle())
//     return BuildMI(BB, MachineBasicBlock::instr_iterator(I), DL, DLL, II, IIS, MCID);
//   return BuildMI(BB, MachineBasicBlock::iterator(I), DL, DLL, II, IIS, MCID);
// }

// inline MachineInstrBuilder BuildMI(MachineBasicBlock &BB, MachineInstr *I,
//                                    const DebugLoc &DL, const DebugLocSet &DLL,
//                                    const InstIndex &II, const InstIndexSet &IIS,
//                                    const MCInstrDesc &MCID) {
//   return BuildMI(BB, *I, DL, DLL, II, IIS, MCID);
// }
...
//                                    const InstIndexSet &IIS, 
//                                    const MCInstrDesc &MCID) {
//   return BuildMI(*BB, BB->end(), DL, DLL, II, IIS, MCID);
// }
...
//                                    const InstIndexSet &IIS,
//                                    const MCInstrDesc &MCID, Register DestReg) {
//   return BuildMI(*BB, BB->end(), DL, DLL, II, IIS, MCID, DestReg);
// }
...
// dingzhu patch: add para DLL, II, IIS
